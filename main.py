...
def main():
    ...
    mlflow.set_experiment("Churn Prediction - KNN Classifier")
    mlflow.enable_system_metrics_logging()

    with mlflow.start_run(run_name="KNN Classifier Baseline"):
        time.sleep(15)
        ...
        print("\n=== Loading saved model ===")
        loaded_model, loaded_encoder, loaded_scaler = load_model("knn_model.pkl")
